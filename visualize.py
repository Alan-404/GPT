...
def draw_model(tokenizer_path: str, n: int, d_model: int, heads: int, d_ff: int, activation: Callable[[torch.Tensor], torch.Tensor], dropout_rate: float, eps: float, saved_path: str):
    ...
    dot.render(f"{saved_path}/gpt_model", format='png')
...
if __name__ == '__main__':
    ...
    parser.add_argument("--saved_path", type=str, default='./assets')
    # Model Config
